    ...
    <div className="w-full pt-2 font-sans relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#111620]/80 backdrop-blur-xl border border-white/5 p-6 rounded-2xl flex items-center gap-4 shadow-xl">
          ...
          <div><div className="text-3xl font-black text-white">{stats.suspended || clientUsers.filter(u=>u.status==='suspended').length}</div><div className="text-slate-500 text-[11px] font-bold uppercase tracking-widest">Suspended</div></div>
        </div>
      </div>
          ...
          <table className="w-full text-left">
            ...
            <tbody className="text-white">
              {clientUsersLoading && clientUsers.length === 0 ? (
                ...
                return (
                  <tr key={user._id || user.id} className="border-b border-white/5 hover:bg-white/[0.03] transition-colors group">
                    <td className="p-5">
